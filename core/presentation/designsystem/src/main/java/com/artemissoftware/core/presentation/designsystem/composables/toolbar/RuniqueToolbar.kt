...
package com.artemissoftware.core.presentation.designsystem.composables.toolbar
...
import com.artemissoftware.core.presentation.designsystem.ArrowLeftIcon
...
@Preview
@Composable
private fun RuniqueToolbarWithBackButtonPreview() {
    RuniqueTheme {
        RuniqueToolbar(
            showBackButton = true,
            title = "Runique",
